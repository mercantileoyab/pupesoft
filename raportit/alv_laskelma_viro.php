...
function alvlaskelma($kk, $vv) {
  ...
  if (isset($kk) and $kk != '') {
    ...
    echo "<tr class='aktiivi'><td>&raquo; <a href = '?tee=erittele&ryhma=1.1&vv=$vv&kk=$kk&etsivirheita=$etsivirheita'>1.1)</a> 20% määraga maksustatavad toimingud ja tehingud</td><td align='right'>".sprintf('%.2f', $ee100["20.00"])."</td></tr>";
    ...
    echo "<tr class='aktiivi'><td>&raquo; <a href = '?tee=erittele&ryhma=2.1&vv=$vv&kk=$kk&etsivirheita=$etsivirheita'>2.1)</a> 5% määraga maksustatavad toimingud ja tehingud</td><td align='right'>".sprintf('%.2f', $ee110["5.00"])."</td></tr>";
